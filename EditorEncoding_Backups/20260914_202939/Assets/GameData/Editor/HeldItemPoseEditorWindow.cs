    ...
    EditorWindow
{
    ...
    private void DrawInspector()
    {
        ...
        )
        {
            ...
            EditorGUILayout.HelpBox(
                "FrontArmPivot РЅРµ РЅР°Р№РґРµРЅ. Р’С‹РґРµР»Рё Player Рё СЃРЅР°С‡Р°Р»Р° Р·Р°РїСѓСЃС‚Рё Tools в†’ Game в†’ Setup Mining Arm Overlay.",
                MessageType.Error
            );
        ...
        )
        {
            ...
            EditorGUILayout.HelpBox(
                "HandPoint РЅРµ РЅР°Р№РґРµРЅ. Р—Р°РїСѓСЃС‚Рё Setup Mining Arm Overlay.",
                MessageType.Warning
            );
        ...
        if (
            GUILayout.Button(
                "РџСЂРёРјРµРЅРёС‚СЊ HandPoint РІ СЃС†РµРЅСѓ"
            )
        )
        {
        ...
        EditorGUILayout.LabelField(
            "РџРѕР»РѕР¶РµРЅРёРµ РїСЂРµРґРјРµС‚Р°",
            EditorStyles.boldLabel
        );
        ...
        EditorGUILayout.LabelField(
            "РљР°РјРµСЂР° РїСЂРµРґРїСЂРѕСЃРјРѕС‚СЂР°",
            EditorStyles.boldLabel
        );
        ...
        if (
            GUILayout.Button(
                "РЎРѕС…СЂР°РЅРёС‚СЊ HandPoint + Item Pose",
                GUILayout.Height(
                    34f
                )
            )
        ...
        EditorGUILayout.HelpBox(
            "РџСЂРµРґРїСЂРѕСЃРјРѕС‚СЂ С‚РµРїРµСЂСЊ СЏРІР»СЏРµС‚СЃСЏ РєРѕРїРёРµР№ СЂРµР°Р»СЊРЅРѕРіРѕ Player hierarchy. " +
            "РџРѕСЌС‚РѕРјСѓ РІ РЅС‘Рј РІРёРґРЅС‹ Body, FrontArmPivot, BackArmPivot, РЅРѕРіРё, РіРѕР»РѕРІР° Рё СЃР°Рј РїСЂРµРґРјРµС‚. " +
            "Р’С‹Р±СЂР°РЅРЅС‹Р№ AnimationClip РїСЂРѕРёРіСЂС‹РІР°РµС‚СЃСЏ РїСЂСЏРјРѕ РЅР° СЌС‚РѕР№ РєРѕРїРёРё.",
            MessageType.Info
        );
    ...
    private void DrawAnimationControls()
    {
        ...
        )
        {
            ...
            EditorGUILayout.HelpBox(
                "Р’ RuntimeAnimatorController РЅРµ РЅР°Р№РґРµРЅРѕ AnimationClip.",
                MessageType.Warning
            );
        ...
        )
        {
            ...
            EditorGUILayout.LabelField(
                "Mining overlay",
                "РїСЂРёРјРµРЅСЏРµС‚СЃСЏ РїРѕСЃР»Рµ SampleAnimation"
            );
    ...
    )
    {
        ...
        )
        {
            ...
            GUI.Label(
                inner,
                "Р’С‹РґРµР»Рё Player РІ Hierarchy",
                new GUIStyle(
        ...
        )
        {
            ...
            GUI.Label(
                inner,
                "Р’ preview-РєРѕРїРёРё Player РЅРµ РЅР°Р№РґРµРЅРѕ Р°РєС‚РёРІРЅС‹С… SpriteRenderer.",
                new GUIStyle(
                    EditorStyles.centeredGreyMiniLabel
                )
                {
        ...
        GUI.Label(
            ...
            "РљРѕР»РµСЃРѕ вЂ” zoom, СЃСЂРµРґРЅСЏСЏ РєРЅРѕРїРєР° вЂ” pan. Preview СЂРёСЃСѓРµС‚СЃСЏ РЅР°РїСЂСЏРјСѓСЋ РёР· SpriteRenderer.",
            EditorStyles.whiteMiniLabel
        );
    ...
    private string GetPreviewStatus()
    {
        ...
        )
        {
            ...
            return
                "Р РµР°Р»СЊРЅС‹Р№ Player rig вЂ” Р±РµР· РІС‹Р±СЂР°РЅРЅРѕРіРѕ clip";
    ...
    private void SaveItemJson()
    {
        ...
        EditorUtility.DisplayDialog(
            "Held Item Pose",
            "HandPoint Рё item pose СЃРѕС…СЂР°РЅРµРЅС‹.",
            "OK"
        );
